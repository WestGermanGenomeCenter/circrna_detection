...
# example; Rscript --vanilla auto_filtering.R find_circ/allsamples_m_heatmap.find_circ.tsv circex1/allsamples_m_heatmap.circex1.tsv dcc/matrixtwo_out_allsamples_dcc.tsv
...
write.csv(ordered_circex,file = "ordered_circex_approved_by_all_three.csv",row.names=F)
write.csv(ordered_findc,file = "ordered_find_circ_approved_by_all_three.csv",row.names=F)
write.csv(ordered_dcc,file = "ordered_dcc_approved_by_all_three.csv",row.names=F)
